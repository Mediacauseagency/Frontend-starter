...
},{"./helpers/data/charts":3,"./helpers/data/incrementAnimation":4,"./helpers/data/prettyNumber":5,"./helpers/data/swapText":6,"./helpers/data/toggleClasses":7,"./helpers/htmlToText":8}],2:[function(require,module,exports){
'use strict';
...
var colors = window.ENV && window.ENV.chartColors ? window.ENV.chartColors : ['tomato', 'blue', 'goldenrod'];

var largerYear = function largerYear(y1, y2, gt) {
  if (gt) {
...
var createDataSets = function createDataSets(series, datapoints, projection, cb) {
...
var mergeOptionsByType = {
  ...
  bar: function bar(_ref2) {
    ...
    var bgColors = labels.map(function (l) {
      return largerYear(currentYear, l) ? color : 'rgba(0,0,0,0.2)';
    });
  ...
  var latestYear = labels[labels.length - 1];

  if (chartType === 'line' && largerYear(latestYear, currentYear)) {
    datasets = createDataSets(series, datapoints, false, function (arr, i, ii) {
      return largerYear(currentYear, labels[ii]) ? arr[i] : NaN;
    });
    datasets = datasets.concat(createDataSets(series, datapoints, true, function (arr, i, ii) {
      return largerYear(labels[ii], currentYear) ? arr[i] : NaN;
    }));
  }
  if (chartType === 'bar') {
  ...
  var createDataset = function createDataset(_ref3) {
    ...
    return mergeOptionsByType[chartType]({ baseOptions: baseOptions, i: i, projection: projection, labels: labels });
  };
...
},{"../prettyNumber":9,"chart.js":12,"format-number":68}],4:[function(require,module,exports){
'use strict';
...
},{"../addScrollEvents":2,"../toggleInView":11,"format-number":68}],5:[function(require,module,exports){
'use strict';
...
},{"../prettyNumber":9}],6:[function(require,module,exports){
'use strict';
...
},{"../style":10}],7:[function(require,module,exports){
'use strict';
...
},{"format-number":68}],10:[function(require,module,exports){
"use strict";
...
},{"../core/core.defaults":30,"../helpers/index":50,"moment":69}],63:[function(require,module,exports){
/* MIT license */
